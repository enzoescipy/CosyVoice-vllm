...
class CosyVoice2Model(CosyVoiceModel):
    ...
    def load_vllm(self, model_dir):
        ...
        engine_args = EngineArgs(model=model_dir,
                                 skip_tokenizer_init=True,  ## WAS Additional skip for the compatiblity => Unstable. pending for activation
                                 enable_prompt_embeds=True, ## WAS not supported in vllm==0.5.3.post1, the compatible version
